...
class _QuizSubjectUiState extends State<QuizSubjectUi> {
  ...
  void storeAnswer(num questionId, num answerId, num resultId, num index,
    ...
    if (existingIndex != -1) {
      ...
      selectedAnswers
          .add(SentAnswerModel(answer_id: answerId, result_id: resultId,index: index,answer_text: answer_text,
          answer_tarqem: answer_tarqem));
    }
...
// List.suffle(){}
                        ...
                        //! sperated question
              int     totalindex    =state.question_with_answer.problems!.length +
                        state.question_with_answer.separated_questions.length;
                 int       sepratedIndex=index- state.question_with_answer.problems!.length;
                                    ...
                                    onTap: () {
                                      ...
                                      storeAnswer(
                                          ...
                                          state
                                              ...
                                              .answers[0]
                                              .id!,
                                          state.question_with_answer.result_id,index,state
                                        .question_with_answer
                                        .separated_questions[sepratedIndex]
                                        .answers[0]
                                        .answer_text!,"أ");
                          ...
                          return SendAnswerUI(
                            ...
                            itemcount:
                                state.question_with_answer.problems!.length +
                                    state.question_with_answer
                                        .separated_questions.length, list: selectedAnswers,
